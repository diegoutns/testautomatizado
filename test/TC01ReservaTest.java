...
public class TC01ReservaTest {
    ...
    public void testReserva() {
        ...
        driver.findElement(By.name("passFirst0")).sendKeys("Ever");
        driver.findElement(By.name("passLast0")).clear();
        driver.findElement(By.name("passLast0")).sendKeys("Ludueña");
        driver.findElement(By.name("creditnumber")).clear();
        driver.findElement(By.name("creditnumber")).sendKeys("555000042");
